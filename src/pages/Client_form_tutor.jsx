...
import Form from '../components/filters/form.jsx';
...
const ClientTutorFormPage = () => {
  ...
  return (
    <>
      ...
      <div className='w-[180px] h-[180px] mt-[170px] ml-[150px] mb-[300px]'>
        ...
        <p className='text-black text-2xl font-display-[Roboto] font-bold  absolute top-[1250px] right-[453px]'>Не создано пока ни одной заявки на поиск учителя</p>
      </div>
    
      <div className=' mr-[940px]'>
...
export default ClientTutorFormPage;