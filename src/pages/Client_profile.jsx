...
import img_1_empty_client from '../images/img_1_empty_client.svg';
import img_2_empty_client from '../images/img_2_empty_client.svg';
//info_about
...
import ProfileSwitchButtonClient from '../components/buttons/changeFromClientProf.jsx';
import UserForm from '../components/buttons/userForm.jsx';
import Footer from '../components/footer/footer.jsx';

// Основная страница профиля заказчика с пустой информацией
const ClientProfilePage = () => {
  ...
  const goToClientTutorPage = () => {
    navigate('/client_tutor'); 
  };

  const goToClientTeacherPage = () => {
    navigate('/client_teacher'); 
  };
  ...
  return (
    <>
      {/* Блок сверху справа с текстом входа как заказчик */}
      <ProfileSwitchButtonClient />
      
      {/* Контейнер основного содержимого профиля */}
      <div className='bg-white  w-[1240px] h-[320px] mt-[50px] mr-[120px] ml-[120px]  rounded-xl relative '>
        {/* Левый блок с иконкой загрузки фото */}
      ...
      <div className='w-[180px] h-[180px] mt-[120px]  ml-[120px] mb-[100px]'>
        <img src={img_1_empty_client} alt='img_1_empty_client' className='w-[170px] h-[170px] mt-[150px] ml-[544px] hover:cursor-pointer' onClick={goToClientTutorPage}  />
        <p className='text-black text-2xl font-display-[Roboto] font-bold  absolute top-[895px] right-[443px]'>Не создано пока ни одной заявки на поиск репетитора</p>
      </div>

      <div className='w-[180px] h-[180px] mt-[170px] ml-[120px] mb-[300px]'>
        <img src={img_2_empty_client} alt='img_2_about_project' className='w-[170px] h-[170px] ml-[544px] hover:cursor-pointer' onClick={goToClientTeacherPage}  />
        <p className='text-black text-2xl font-display-[Roboto] font-bold  absolute top-[1250px] right-[463px]'>Не создано пока ни одной заявки на поиск учителя</p>
      </div>
    
      <div className=' mr-[950px]'>
