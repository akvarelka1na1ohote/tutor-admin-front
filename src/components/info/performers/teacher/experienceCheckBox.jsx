...
const ExperienceTeacher = ({ onExperienceChange }) => {
  ...
  return (
    <div className="absolute top-[1200px] left-[570px]">
      <label className="text-sm font-medium text-slate-600">Наличие опыта</label>
