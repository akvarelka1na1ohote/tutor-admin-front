...
// Новый комбинированный компонент ProfileSwitchButton
const ProfileSwitchButtonPerf = () => {
    ...
    const changeToClient = () => {
        closeModal();
        console.log('Пользователь вошёл как заказчик');
        navigate('/client_profile'); 
    };

    const logOut = () => {
        closeModal();
        console.log('Пользователь вышел из учётной записи');
    ...
    return (
        <>
            <div className='mt-[120px] ml-[970px] rounded-3xl bg-gray-50 w-[393px] h-[50px] hover:cursor-pointer' onClick={openModal}>
                ...
                <p className=' text-black text-xl font-display-[Roboto] mt-[-40px] ml-[-20px] hover:cursor-pointer'>Вы вошли как исполнитель</p>
            </div>
...
export default ProfileSwitchButtonPerf;