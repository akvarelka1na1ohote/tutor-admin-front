...
const OutButtonPerf = () => {
    ...
    const navigate = useNavigate(); 
        ...
        const goToPerformerPage = () => {
            closeModal();
            console.log('Пользователь вошел как заказчик');
    ...
    return (
        <>
            <button 
                className='bg-red-600 hover:cursor-pointer w-[170px] h-[50px] font-display-[Roboto] absolute top-[155px] right-[60px] rounded-xl'
                onClick={openModal}
            >
                Выход
            </button>
