...
const AddItemsTutorButton = () => {
  ...
  return (
    <div>
      ...
      <button className="bg-blue-500 text-white hover:cursor-pointer w-[40px] h-[40px] absolute top-[70px] left-[370px] rounded-xl"
...
export default AddItemsTutorButton;